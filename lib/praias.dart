...
class Teste extends StatefulWidget {
  ...
  @override
  State<Teste> createState() => TesteState();
}
...
class PraiasP extends StatefulWidget {
  const PraiasP({super.key});

  @override
  State<PraiasP> createState() => PraiasState();
}
